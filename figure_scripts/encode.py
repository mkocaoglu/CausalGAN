...
class Encoder:
    '''
    This is a class where you pass a model, and an image file and it creates more tensorflow variables, along with surrounding saving and summary functionality for encoding that image back into the hidden space using gradient descent
    '''
    ...
    def __init__(self,model,image,image_name=None,load_path=''):
        ...
        self.g_optimizer = optimizer(0.0005)
    ...
    def train(self, num_step=5000):
        for counter in trange(5000):
            fetch_dict = {
