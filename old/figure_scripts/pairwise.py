...
def crosstab(cc,result_dir=None,report_tvd=True):
    '''
    ...
    N=1000*n_labels#Not really sure how this should scale
...
def old_crosstab(model,step=None,result_dir=None,report_tvd=True):
    '''
    This is a script for outputing [0,1/2], [1/2,1] binned pdfs
    including the marginals and the pairwise comparisons
